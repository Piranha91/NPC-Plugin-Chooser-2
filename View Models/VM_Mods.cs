...
namespace NPC_Plugin_Chooser_2.View_Models
{
    public class VM_Mods : ReactiveObject
    {
        ...
        public void AddAndRefreshModSetting(VM_ModSetting newVm)
        {
            ...
            var baseGameSetting = _allModSettingsInternal.FirstOrDefault(x => x.DisplayName == BaseGameModSettingName);
            var creationClubSetting =
                _allModSettingsInternal.FirstOrDefault(x => x.DisplayName == CreationClubModsettingName);

            if (creationClubSetting != null)
            {
                _allModSettingsInternal.Remove(creationClubSetting);
                _allModSettingsInternal.Insert(0, creationClubSetting);
            }

            if (baseGameSetting != null)
            {
                _allModSettingsInternal.Remove(baseGameSetting);
                _allModSettingsInternal.Insert(0, baseGameSetting);
            }
            ...
            double progressSpan = 10)
        {
            ...
            if (creationClubModKeys.Any())
            {
                ...
                _allModSettingsInternal.Insert(0, ccMod);
            }
            ...
            if (baseGameModKeys.Any())
            {
                ...
                _allModSettingsInternal.Insert(0, baseMod);
            }
