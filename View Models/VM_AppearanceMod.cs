...
// --- Existing fields ---
        ...
        {
            Debug.WriteLine(
                $"VM_AppearanceMod.Dropped (Source): '{this.ModName}' was dropped with effect {dropInfo.Effects}");
        }
        ...
        {
            Debug.WriteLine(
                $"VM_AppearanceMod.DragDropOperationFinished: Operation for '{this.ModName}' finished with result {operationResult}.");
        }
        ...
        {
            Debug.WriteLine(
                $"ERROR VM_AppearanceMod.TryCatchOccurredException (Source): Exception during D&D for '{this.ModName}': {exception}");
            return true;
        }
